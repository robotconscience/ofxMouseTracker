...
//------------------------------------------------------------
void ofxCocoaWindowNibless::setWindowLevel(int windowLevel) {
	[[[NSApp delegate]  glWindow] setLevel:windowLevel];
}

//------------------------------------------------------------
int	ofxCocoaWindowNibless::getWindowLevel() {
	return [[[NSApp delegate]  glWindow] level];
}


//------------------------------------------------------------
void ofxCocoaWindowNibless::setCaptureExternalMouseEvents(bool b){
	[[[NSApp delegate] glView] setCaptureExternalMouseEvents:b];
}

//------------------------------------------------------------
bool ofxCocoaWindowNibless::getCaptureExternalMouseEvents(){
	return [[[NSApp delegate] glView] captureExternalMouseEvents];
}
